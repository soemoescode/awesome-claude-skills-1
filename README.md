...
| **[GuardSkill](https://github.com/soemoescode/guardskill)** | Scans a project for git settings and hook scripts that make a coding agent execute code when it opens the folder |
